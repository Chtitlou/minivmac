...
printf "\n" >> "${DestFile}"
printf "%s\n" '#define vMacScreenHeight 540' >> "${DestFile}"
printf "%s\n" '#define vMacScreenWidth 960' >> "${DestFile}"
printf "%s\n" '#define vMacScreenDepth 3' >> "${DestFile}"
printf "\n" >> "${DestFile}"
...
printf "%s\n" '#define VarFullScreen 0' >> "${DestFile}"
printf "%s\n" '#define MayFullScreen 1' >> "${DestFile}"
printf "%s\n" '#define MayNotFullScreen 0' >> "${DestFile}"
...
printf "\n" >> "${DestFile}"
printf "%s\n" '#define NeedIntlChars 1' >> "${DestFile}"
...
printf "\n" >> "${DestFile}"
printf "%s\n" '#define kBldOpts "-br 36 -t lx64 -lang fre -m II -hres 960 -vres 540 -fullscreen 1 -var-fullscreen 0"' >> "${DestFile}"
...
printf "%s\n" '#define kVidMemRAM_Size 0x00080000' >> "${DestFile}"
printf "\n" >> "${DestFile}"
...
printf "\n" >> "${DestFile}"
printf "%s\n" 'bld/OSGLUSD2.o : src/OSGLUSD2.c src/STRCNFRE.h cfg/STRCONST.h src/INTLCHAR.h src/COMOSGLU.h src/CONTROLM.h cfg/CNFGGLOB.h' >> "${DestFile}"
printf "%s\n" '	gcc "src/OSGLUSD2.c" -o "bld/OSGLUSD2.o" $(mk_COptions)' >> "${DestFile}"
